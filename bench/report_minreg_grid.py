...
def main():
    ap = argparse.ArgumentParser(description="Summarize minreg grid sweep results.")
    ap.add_argument("csv_path", help="peer_bench.csv path")
    ap.add_argument("--out", default="minreg_grid_summary.csv",
                    help="Output CSV path")
    ap.add_argument("--method", default="M4_TimeSyncMinReg",
