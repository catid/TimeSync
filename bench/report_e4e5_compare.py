...
def main():
    ap = argparse.ArgumentParser(description="Compare methods across E4-E5 scenarios.")
    ap.add_argument("csv_path", help="peer_bench.csv path")
    ap.add_argument("--out", default="e4e5_compare.md", help="Output markdown path")
    ...
    lines = []
    lines.append("# E4-E5 Regression Comparison")
    lines.append("")
