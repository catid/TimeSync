...
OUT_DIR="${1:-${ROOT_DIR}/benchmarks/run_moe_e7_e53_$(date +%Y%m%d_%H%M%S)}"
mkdir -p "${OUT_DIR}"
...
METHODS=(
  ...
  "M4_TimeSyncMoE:guard1ms"
  "M4_TimeSyncMoE:noguard"
  "M4_TimeSyncMoE:noguard_xor"
)
