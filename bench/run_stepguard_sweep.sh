...
OUT_DIR="${1:-${ROOT_DIR}/benchmarks/run_stepguard_$(date +%Y%m%d_%H%M%S)}"
mkdir -p "${OUT_DIR}"
...
METHODS=(
  ...
  "M4_TimeSyncStepGuard:sym"
  "M4_TimeSyncStepGuard:nonear_p10"
  "M4_TimeSyncStepGuard:rtt_step"
  "M4_TimeSyncStepGuard:near_ratio"
  "M4_TimeSyncStepGuard:single_dir"
